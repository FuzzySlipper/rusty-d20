...
pub use candidate::{
    ...
    AdventureCompletionCandidate, ArmorCandidate, CharacterAbilityCandidate,
    CharacterAffinityCandidate, CharacterAffinityKindCandidate, CharacterResourceCandidate,
    CharacterTemplateCandidate, ConditionClauseCandidate, D20PackageEnvelope, D20RulesCandidate,
...
pub use compiler::{
    ...
    AdventureCompletionDefinition, AdventureDefinition, ArmorDefinition,
    CharacterAffinityDefinition, CharacterAffinityKindDefinition, CharacterTemplateDefinition,
    ConditionClauseDefinition, D20CompileError, D20Ruleset, DamageDefinition, DefenseDefinition,
    DungeonCheckpointDefinition, DungeonDefinition, DungeonDoorDefinition,
...
pub fn generated_typescript() -> String {
    let declarations = [
        ...
        ExplorationDoorDto::decl(),
        ExplorationTreasureDto::decl(),
        ExplorationCheckpointDto::decl(),
        ExplorationDto::decl(),
        EncounterOutcomeKindDto::decl(),
        CampaignOutcomeDto::decl(),
        AdventureCompletionDto::decl(),
