...
| `rust/crates/rusty-d20/src/game.rs` | Product campaign phases and encounter lifecycle, opaque preview custody, projection, optimistic revisions, strict schema migration, bounded explanations, product save/reopen | `cargo test -p rusty-d20 --lib --locked` |
...
| `libs/feature-main-menu/` | Permanent landing/camp/encounter entry, action, status, and receipt feature | Playwright smoke/live evidence |
